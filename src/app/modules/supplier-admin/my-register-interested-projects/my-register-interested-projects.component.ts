...
@Component({
  selector: 'app-my-register-interested-projects',
  templateUrl: './my-register-interested-projects.component.html',
  styleUrls: ['./my-register-interested-projects.component.scss']
})
export class MyRegisterInterestedProjectsComponent implements OnInit {
  ...
  projectDetails(projectId: any) {
    this.router.navigate(['/supplier-admin/projects-details'], { queryParams: { id: projectId, type: 2, source: 'my-register-interested' } });
  }
